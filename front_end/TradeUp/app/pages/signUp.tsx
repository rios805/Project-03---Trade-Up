				...
				<KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.keyboardAvoidingContainer}>
					...
					>
						...
						<View style={[styles.formWrapper, isWeb && { maxWidth: 400 }]}>
							...
							<TextInput ref={nameInputRef} style={[styles.input, nameFocused && styles.inputFocused]} placeholder="Full Name" placeholderTextColor={AppColors.placeholderText} value={name} onChangeText={setName} autoCapitalize="words" returnKeyType="next" onSubmitEditing={() => emailInputRef.current?.focus()} blurOnSubmit={false} textContentType="name" onFocus={() => setNameFocused(true)} onBlur={() => setNameFocused(false)} />
