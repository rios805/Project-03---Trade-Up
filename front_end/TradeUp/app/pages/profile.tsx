...
import { View, Pressable, Text, StyleSheet, Image, ScrollView, useWindowDimensions } from 'react-native';
        ...
        <>
            ...
            <View style={styles.infoRow}>
                ...
                <View style={styles.ratingRow}>
                    <Text>Rating: </Text>
                    <Image source={images.threeStar} style={styles.image} />
                </View>
            </View>
            ...
            <View style={styles.infoRow}>
                <View style={styles.balanceBox}>
                    <View style={styles.balanceBoxSub}>
                        <Text style={styles.balanceText}>Account Value</Text>
                    </View>
                    <View style={{ height: 5 }} />
                ...
                <View style={styles.balanceBox}>
                    <View style={styles.balanceBoxSub}>
                        <Text style={styles.balanceText}>Day Balance</Text>
                    </View>
                    <View style={{ height: 5 }} />
                    <Text style={styles.balanceAmount}>$215.32</Text>
                    <View style={styles.balanceBoxSub}>
                        <Text>Minimum</Text>
                    </View>
                    <View style={{ height: 5 }} />
            ...
            <View style={styles.bannerContainer}>
                <Text style={styles.bannerText}>User Items</Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    scrollContainer: {
        ...
        alignItems: 'center',
        paddingBottom: 20,
        height: '100%',  // Adjust this value to make the scroll area taller
    },
    userItemsContainer: {
        flexDirection: 'row',
        flexWrap: 'wrap',
    ...
    button: {
        ...
        borderRadius: 8,
        alignSelf: 'center', // 👈 keeps it centered but not full width
        marginTop: 20,
    },
    buttonPressed: {
